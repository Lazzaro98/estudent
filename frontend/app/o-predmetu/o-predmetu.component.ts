...
@Component({
  selector: 'app-o-predmetu',
  templateUrl: './o-predmetu.component.html',
  styleUrls: ['./o-predmetu.component.css']
})
...
updated:Boolean;
  ...
  updateDB(){
    ...
    this.userService.updateOPredmetu(this.naziv,this.inf).subscribe((data:Predmet[])=>{
     // alert(1);
    });
  }
}
