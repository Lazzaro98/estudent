...
@Component({
  selector: 'app-predmet-zaposlen',
  templateUrl: './predmet-zaposlen.component.html',
  styleUrls: ['./predmet-zaposlen.component.css']
})
export class PredmetZaposlenComponent implements OnInit {
